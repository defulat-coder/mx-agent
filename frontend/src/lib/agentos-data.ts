...
export const fallbackOverview: WorkspaceOverview = {
  ...
  navigation: [
    ...
    { label: "Studio", href: "/studio/agents", icon: "layout-grid", group: "studio" },
    { label: "Learning", href: "/learning/user_memory", icon: "brain", group: "learning" },
...
export const fallbackTables = {
  ...
  approvals: table(
    ...
    [
      { id: "a-1", action: "web_search", target: "Research Agent", created_at: "24 Feb 2025", status: "pending", params: { query: "latest AI research papers 2026" } },
      { id: "a-2", action: "execute_sql", target: "Data Pipeline Team", created_at: "24 Feb 2025", status: "pending", params: { query: "DELETE FROM staging_table WHERE created_at < NOW() - INTERVAL 30 DAY" } },
      { id: "a-3", action: "send_email", target: "Email Agent", created_at: "24 Feb 2025", status: "approved", params: { to: "team@example.com", subject: "Weekly Report Summary" } },
      { id: "a-4", action: "deploy_service", target: "Deployment Workflow", created_at: "23 Feb 2025", status: "approved", params: { service: "api-gateway", environment: "production" } },
      { id: "a-5", action: "process_payment", target: "Finance Agent", created_at: "24 Feb 2025", status: "pending", params: { amount: 15000, currency: "USD", vendor: "Cloud Services" } },
      { id: "a-6", action: "publish_article", target: "Content Team", created_at: "23 Feb 2025", status: "approved", params: { title: "Q1 Product Update", channel: "blog" } },
      { id: "a-7", action: "scale_cluster", target: "Infrastructure Agent", created_at: "24 Feb 2025", status: "pending", params: { cluster: "prod-us-east", replicas: 10 } },
      { id: "a-8", action: "create_user_account", target: "Onboarding Workflow", created_at: "23 Feb 2025", status: "rejected", params: { email: "new.hire@company.com", role: "engineer" } },
      { id: "a-9", action: "revoke_access", target: "Security Agent", created_at: "24 Feb 2025", status: "pending", params: { user: "former.employee@company.com", scope: "all" } },
      { id: "a-10", action: "send_campaign", target: "Marketing Team", created_at: "23 Feb 2025", status: "rejected", params: { campaign: "Spring Promo", audience: "all_users" } },
    ],
    ["View: All", "Status: Pending", "Status: Approved", "Status: Rejected"],
  ),
  schedules: table(
    "Scheduler",
    "agno_schedules",
    ...
    [
      {
        ...
        next_run: "15 Jun 2025, 16:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-2",
        ...
        cron: "0 * * * *",
        endpoint: "/v1/agents/health/runs",
        next_run: "15 Jun 2025, 21:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-3",
        ...
        cron: "0 2 * * 1",
        endpoint: "/v1/agents/sync/runs",
        next_run: "16 Jun 2025, 09:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-4",
        ...
        cron: "0 3 * * *",
        endpoint: "/v1/agents/cleanup/runs",
        next_run: "15 Jun 2025, 04:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-5",
        ...
        cron: "0 0 1 * *",
        endpoint: "/v1/agents/analytics/runs",
        next_run: "1 Jul 2025, 00:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-6",
        enabled: false,
        name: "Bi-hourly Index Refresh",
        cron: "0 */2 * * *",
        endpoint: "/v1/agents/index/runs",
        next_run: "15 Jun 2025, 23:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-7",
        ...
        cron: "30 22 * * *",
        endpoint: "/v1/agents/eval/runs",
        next_run: "16 Jun 2025, 05:30 UTC",
        updated_at: "-",
      },
      {
        id: "sc-8",
        ...
        next_run: "23 Jun 2025, 04:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-9",
      ...
      },
      {
        ...
        next_run: "16 Jun 2025, 00:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-11",
        ...
        cron: "0 1 */14 * *",
        endpoint: "/v1/agents/retraining/runs",
        next_run: "17 Jun 2025, 01:00 UTC",
        updated_at: "-",
      },
      {
        id: "sc-12",
        ...
        cron: "15 * * * *",
        endpoint: "/v1/agents/cache-warmup/runs",
        next_run: "15 Jun 2025, 22:10 UTC",
        updated_at: "-",
      },
    ],
  ),
